...
export const getDashboardData = async (req, res) => {
    try {
        ...
        // Ensures all priority levels are included
...
export const getUserDashboardData = async (req, res) => {
    try {
        ...
        // Fetch statistics data for user-specific tasks
        ...
        // Fetch recent 10 tasks for the logged-in users
